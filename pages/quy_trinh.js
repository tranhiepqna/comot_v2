            ...
            <div className="flex-col flex mt-3 divide-x-0">
                <div className="flex flex-row">
                    <div className="flex-1">
                        <img src="../static/images/xu_ly.webp" className="h-screen/3 w-screen/2 sm:h-screen/2 object-cover" alt="quy trinh xu ly nguyen lieu"/>
                    </div>
                ...
                <div className="flex flex-row mt-2">
                    ...
                    <div className="flex-1">
                        <img src="../static/images/may_xaay.webp" className="h-screen/3 w-screen/2 sm:h-screen/2 object-cover" alt="quy trình xấy hạt"/>
                    </div>
                </div>
                <div className="flex flex-row mt-2">
                    <div className="flex-1">
                        <img src="../static/images/may_rang.webp" className="h-screen/3 w-full sm:h-screen/2 object-cover" alt="quy trình rang hạt"/>
                    </div>
                    <div className="flex-1 text-justify pl-3 sm:pl-3">
                ...
                <div className="flex flex-row mt-2">
                    ...
                    <div className="flex-1">
                        <img src="../static/images/may_xay.webp" className="h-screen/3 w-screen/2 sm:h-screen/2 object-cover" alt="quy trình xay bột"/>
                    </div>
                </div>
                <div className="flex flex-row mt-2">
                    <div className="flex-1">
                        <img src="../static/images/dong_goi.webp" className="h-screen/3 w-full sm:h-screen/2 object-cover" alt="quy trình đóng gói"/>
                    </div>
                    <div className="flex-1 text-justify pl-3 sm:pl-3">
                ...
                <div className="flex flex-row mt-2">
                    ...
                    <div className="flex-1">
                        <img src="../static/images/thanh_pham.webp" className="h-screen/3 w-screen/2 sm:h-screen/2 object-cover" alt="thành phẩm"/>
                    </div>
                </div>
            </div>
        </section>
