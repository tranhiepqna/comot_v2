    ...
    <Layout>
        ...
        <section className="lg:container lg:mx-auto shadow p-2 sm:p-6 mt-10 mb-20 m-2 flex flex-col justify-center">
            ...
            <div className="flex flex-col sm:flex-row mt-3">
                ...
                <div className="flex-1">
                    <img src="/images/hoi_cho_hoi_an_1.webp" alt="Tham gia hội chợ Quảng Nam" className="h-screen/2 w-full object-contain"/>
                    <p className="pt-2 text-center text-sm">Bột ngũ cốc Cô Một tại Hội chợ thương mại Festival di sản Quảng Nam</p>
                </div>
            </div>
            <div className="flex flex-col sm:flex-row  mt-3">
                <div className="flex-1">
                    <img src="/images/kim_anh.webp" alt="Tạp hóa KIM ANH chợ Việt An - Bình Lâm - Hiệp Đức - Quảng Nam" className="h-screen/2 w-full object-contain"/>
                ...
                <div className="flex-1">
                    <img src="/images/quang_ngai.webp" alt="Bột ngũ cốc Cô Một tại Tạp hóa Tuấn Anh - Phổ Phong- Đức Phổ - Quảng Ngãi" className="h-screen/2 w-full object-contain"/>
                    <p className="pt-2 text-center text-sm">Bột ngũ cốc Cô Một tại Tạp hóa Tuấn Anh - Phổ Phong- Đức Phổ - Quảng Ngãi.</p>
                </div>
            </div>
            <div className="flex flex-col sm:flex-row  mt-3">
                <div className="flex-1">
                    <img src="/images/binh_trieu.webp" alt="Bột ngũ cốc Cô Một tại Cửa hàng Ocop Hợp tác xã Nông nghiệp Bình Đào huyện Thăng Bình" className="h-screen/2 w-full object-contain"/>
                ...
                <div className="flex-1">
                    <img src="/images/hoi_cho_hoi_an.webp" alt="Bột ngũ cốc Cô Một tại Hội chợ thương mại Festival di sản Quảng Nam 2019" className="h-screen/2 w-full object-contain"/>
                    <p className="pt-2 text-center text-sm">Bột ngũ cốc Cô Một tại Hội chợ thương mại Festival di sản Quảng Nam 2019</p>
                </div>
            </div>
            <div className="flex flex-col sm:flex-row  mt-3">
                <div className="flex-1 mr-2">
                    <img src="/images/tra_vinh.webp" alt="Bột ngũ cốc Cô Một tại Hội chợ xúc tiến thương mại định hướng xuất khẩu nông - thuỷ sản Đồng bằng sông Cửu Long 2019" className="h-screen/2 w-full object-contain"/>
            ...
            <div className="flex flex-col sm:flex-row  mt-3">
                ...
                <div className="flex-1 ml-2">
                    <img src="/images/an_toan_ha_lam.webp" alt="Bột ngũ cốc Cô Một tại Hội chợ xúc tiến thương mại định hướng xuất khẩu nông - thuỷ sản Đồng bằng sông Cửu Long 2019" className="h-screen/2 w-full object-contain"/>
                    <p className="pt-2 text-center text-sm">Bột Ngũ cốc Cô Một được bày bán tại Cửa hàng thực phẩm an toàn Quảng Nam, TT Hà Lam, Thăng Bình, Quảng Nam.</p>
                </div>
            </div>
        </section>
    </Layout>
